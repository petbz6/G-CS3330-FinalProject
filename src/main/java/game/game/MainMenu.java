...
public class MainMenu {
	...
	public static void main(String[] args) {
	    ...
	    while (true) {
		    ...
		    System.out.println("Wleome to the DnD Game!");
        ...
        case 1:
            ...
            break;
        case 2:
            System.out.print("You will create a either a fighter, wizard, or rogue which each have unique stats."
            ...
            System.out.print("\nLets begin by making a character!\n");
            CharacterSelector.main(args);
            break;
        case 3:
